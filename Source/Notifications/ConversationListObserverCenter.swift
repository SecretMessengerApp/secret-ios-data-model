...
public class ConversationListObserverCenter : NSObject, ChangeInfoConsumer {
    ...
    public func conversationDidChange(_ changes: ConversationChangeInfo) {
        guard          changes.nameChanged
                    ...
                    || changes.selfRemarkChanged
                    || changes.previewAvatarDataChanged
                    || changes.replyTypeChanged
                    || changes.placeTopStatusChanged
                    || changes.messagesChanged
                    || changes.labelsChanged
                    || changes.remoteIdentifierChanged
                    || changes.notDisturbStatusChanged
